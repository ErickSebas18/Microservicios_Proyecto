...
@EnableFeignClients
public class ComentarioLifeCycle implements ApplicationListener<WebServerInitializedEvent> {
    ...
    private String serviceName = "app-comentarios";
    ...
    public static void main(String[] args) {
        SpringApplication.run(ComentarioLifeCycle.class, args);
    }
}
